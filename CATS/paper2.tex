...
monads in the denotational semantics, as presented in \citet{Liang:phd1998,Liang_Hudak:ESOP1996},
...
in \citet{Wadler:1989:TF:99370.99404}. This work is a special application
of the parametricity in the field of language semantics and analysis.

On the type analysis of dynamic languages, \citet{Anderson:ECOOP2005,Anderson:ENTCS2005,Guha:ESOP2011,Wrigstad:POPL2010}
...
mainly to improve performance. \citet{Ancona:2007:RST:1297081.1297091,Dufour:2006}
...
(\citet{Bracha:1990:MI:97946.97982}) functions, where, by passing
...
functions (\citet{Anderson:ECOOP2005,Vub-prog-tr96aformalisation}).
...
\citet{Jensen:SAS2009} built a feature-complete analyser for JavaScript
...
\end{defn}
Now we turn to examine properties of the monad. \citet{Liang:phd1998}
...
any given type information has been noted in \citet{Bono:arXiv2012}.
...
language, as developed and presented in \citet{Anderson:ECOOP2005,Anderson:ENTCS2005}
...
of $\lambda_{S}$ language as devised in \citet{Guha:2011:TLC:1987211.1987225}.
...
\end{defn}
\begin{figure*}
\framebox{\begin{minipage}[t]{1\textwidth}%
\begin{align*}
...
to take account of IO operations.%
\end{minipage}}

\caption{Concrete functions}
\label{concfunc}
